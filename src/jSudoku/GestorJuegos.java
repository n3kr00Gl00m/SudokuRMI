 ...
 * @author jmmartin
 */
public interface GestorJuegos extends Remote {

    //Dado una dificultad crea un sudoku y devuelve su código.
    int NuevoJuego(Sudoku.dificultad pDifi) throws RemoteException;

    //Dado un código de sudoku lo elimina. Devuelve true si se ha realizado, false si el juego no existe.
    boolean BorrarJuego(int idSudoku) throws RemoteException;
